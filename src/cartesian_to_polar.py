...
def cartesian_to_polar(input_folder, polar_output_folder, lidar_polar_output_folder, lidar_cartesian_output_folder, max_radius=256, num_spokes=250):
    ...
    cartesian_mask_folder = lidar_cartesian_output_folder + "_mask"
    os.makedirs(cartesian_mask_folder, exist_ok=True)
    ...
    for img_file in image_files:
        ...
        if os.path.exists(lidar_cartesian_mask_out_path):
            continue
