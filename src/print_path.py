...
def print_path(map_image_path, center_txt_path, angles_txt_path, output_path_img, output_path_gif, line_length=5, gif_output=False):
    if os.path.exists(center_txt_path) and os.path.exists(angles_txt_path):
