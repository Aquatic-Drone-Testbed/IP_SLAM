...
while True:
    print(f"---- SLAM Iteration: {slam_iteration} ---- ")
    slam_iteration += 1
    ...
    orient_scans(processed_folder, cartesian_output_folder, aligned_folder, transformations_file, gif_processed_path, gif_original_path, gif_unoriented_path, gif_output)
    ...
    reverted_polar = "scans/5_reverted_polar"
    lidar_polar = "scans/5_reverted_polar_lidarized"
    lidar_cartesian = "scans/5_lidar_cartesian"
    print(f"\t5...Mask Generation...")
    ...
    gif_map_path = "scans/6_stitching_process_test.gif"
    gif_map_path_overlay = "scans/6_stitching_process_overlay.gif"
    print(f"\t6...Stitch Map Filtered...")
    ...
    test_stitch2(aligned_folder + "_orig", lidar_cartesian + "_mask", output_map_path, output_map_path_frames, map_parts_output, gif_map_path, gif_map_path_overlay,center_file, pixel_threshold=150, gif_output=gif_output)
