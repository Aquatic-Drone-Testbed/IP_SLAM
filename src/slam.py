...
output_map_path_bw = "scans/7_stitched_map_test_bw.png"
map_parts_output = "scans/7_stitched_maps_steps_test"
center_file = "scans/7_centers.txt"
gif_map_path = "scans/7_stitching_process_test.gif"
print(f"7...Stitch Map Filtered...")
# test_stitch(aligned_folder + "_orig", output_map_path, output_map_path_bw, map_parts_output, gif_map_path, center_file, pixel_threshold=150)
...
output_map_path_bw = "scans/8_stitched_map_test_bw.png"
...
test_stitch2(aligned_folder + "_orig", lidar_cartesian + "_mask", output_map_path, output_map_path_bw, map_parts_output, gif_map_path, center_file, pixel_threshold=150)
