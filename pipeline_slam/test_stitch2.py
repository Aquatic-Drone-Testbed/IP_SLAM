...
def test_stitch2(aligned_folder, mask_folder, output_map_path, grayscale_output_path, match_output_folder, gif_output_path, center_log_path, canvas_size=(500, 500), min_inliers=20, pixel_threshold=100, visible_radius=60, prob_threshold=0.3):
    ...
    for i, (scan_gray, pose) in enumerate(zip(scans, poses)):
        ...
        cv2.imwrite(f"scans/5_stitched_map_pt/stitched_{format(i, '03')}.png", bw_frame)
    ...
    cv2.imwrite(grayscale_output_path, final_bw_prob_map)
