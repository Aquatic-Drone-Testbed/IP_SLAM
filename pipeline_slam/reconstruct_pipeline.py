...
# ── CONFIG ─────────────────────────────────────────────────────────────────────
RAW_DATA_DIR    = Path("data/raw_dumps")        # incoming .txt scans
PROCESSED_DIR   = Path("data/processed_dumps")  # move here after processing
VALID_ROOT      = Path("data/valid_frames")     # root for outputs
        ...
        for txt in all_txt:
            ...
            try:
                polar_path, cart_path, heat_path = reconstruct_scan_single(
                    ...
                    polar_output_folder=str(VALID_ROOT / "cartesian"),
